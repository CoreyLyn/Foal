...
func TestValidateWindowsTempIdentity_AcceptsStableCandidate(t *testing.T) {
	...
	if _, ok := validateWindowsTempIdentity(wtIdentityCandidate(root, child)); !ok {
...
func TestValidateWindowsTempIdentity_RejectsWrongCategory(t *testing.T) {
	...
	reason, ok := validateWindowsTempIdentity(candidate)
...
func TestValidateWindowsTempIdentity_RejectsPathOutsideRoot(t *testing.T) {
	...
	if _, ok := validateWindowsTempIdentity(wtIdentityCandidate(root, drifted)); ok {
	...
	if _, ok := validateWindowsTempIdentity(wtIdentityCandidate(root, outside)); ok {
...
func TestValidateWindowsTempIdentity_RejectsReparsePoint(t *testing.T) {
	...
	if _, ok := validateWindowsTempIdentity(wtIdentityCandidate(root, link)); ok {
...
func TestValidateWindowsTempIdentity_RejectsMissingPath(t *testing.T) {
	...
	if _, ok := validateWindowsTempIdentity(wtIdentityCandidate(root, missing)); ok {
...
func TestValidateWindowsTempIdentity_RejectsUnresolvableRoot(t *testing.T) {
	...
	if _, ok := validateWindowsTempIdentity(candidate); ok {
